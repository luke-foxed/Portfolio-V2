  ...
  return (
    <div id='about' className={classes.root}>
      ...
      <Grid container spacing={1} alignContent='center' alignItems='center'>
        ...
        <Grid item sm={2}>
          <Typography variant='h4' className={classes.sideHeader}>
            <School style={{ paddingRight: '10px', color: '#03a3ff' }} />
            Education
          </Typography>
        </Grid>
        ...
        <Grid item sm={4}>
          ...
          <Typography style={{ color: '#a3a29b', fontSize: '18px' }}>
            I am currently in my 4th year in Waterford Institute of Technology.
            I will be graduating in Autumn of 2020 with a level 8 degree in
            Applied Comuting with a specialty in Forensics and Security.
          </Typography>
        </Grid>
      ...
      <Grid container spacing={1} alignContent='center' alignItems='center'>
        ...
        <Grid item sm={2}>
          <Typography
            ...
            style={{ color: 'white' }}>
            <Work style={{ paddingRight: '10px', color: '#03a3ff' }} />
            Experience
          </Typography>
        </Grid>
        <Grid item sm={4}>
